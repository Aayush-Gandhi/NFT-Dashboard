    ...
    return (
        <div className='flex gap-20'>
            <div className='relative'>
                <input type="text" placeholder='Search by creator or collection' className='w-[550px] border rounded-2xl text-center p-5 placeholder:text-[#A1A5B6] text-xl' />
                <BiSearch className='absolute -translate-y-12 translate-x-5 w-10 h-6 text-[#A1A5B6]' />
            </div>
            <div className='flex gap-5 text-xl'>
                <button className='flex border items-center rounded-2xl gap-2 w-fit px-5 '>
                    <FaEthereum />
                    <span> 3,25 ETH</span>
                </button>
                <div className='border rounded-2xl flex items-center px-5'>
